...
public class RestAPIHelper {
	...
	public Response patchAPIRequest(String uri, String requestBody, Header header) {
		return RestAssured.given().contentType(ContentType.JSON).body(requestBody)
	...
	public Response deleteAPIRequest(String uri, String requestBody, Header header) {
		return RestAssured.given().contentType(ContentType.JSON).header(header)
	...
	public static Map getCookiesData() {
		...
		cookie.put("skill1", "rest assured by Ajay");
		cookie.put("skill2", "postman by Ajay");
		cookie.put("skill3", "specflow by Ajay");
		return cookie;
	}
